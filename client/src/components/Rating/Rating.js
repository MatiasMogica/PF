...
import { postLikes } from "../../redux/actions/LikeAction";
...
export default function Rating() {
  ...
  const { likes, percentageOfLikes, votesTotal, dislikes } = useSelector(
    (state) => state.likes
  );
  ...
  return (
    <div>
      <div className="likesContainer">
        <button className="likesButtons" onClick={openedLike}>
          <Like />
        </button>
        <button className="likesButtons" onClick={openedDislike}>
          <DisLike />
        </button>
      </div>

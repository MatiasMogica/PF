...
export default function FailurePayment(){
    ...
    return(
        <div>
            ...
            <p className="modal_text">There was an error in the process of your purchase. Please check your details and try again.</p>
            <Link to={'/cart'}><button className='modal-failure-close' onClick={closeModal}>BACK TO CART</button></Link>
            </Modals>
        </div>
    )
}
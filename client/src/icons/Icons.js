export const Star = () => {
    return (
        <>
            <svg color="yellow" xmlns="http://www.w3.org/2000/svg" fill="yellow" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
...
export const Remove = () => {
    return (
        <>
            <svg color="red" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
...
export const Trash = () => {
    return (
        <>
            <svg color="white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
...
export const Confirm = () => {
    return (
        <>
            <svg color="green" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
...
export const RemoveComment = () => {
    return (
        <>
            <svg xmlns="http://www.w3.org/2000/svg" color="white" fill="red" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
